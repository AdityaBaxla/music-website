...
<template>
  <div class="min-h-screen bg-[#242424] text-white">
    <Disclosure
      as="nav"
      class="bg-[#1a1a1a] sticky top-0 z-50"
      v-slot="{ open }"
    >
        ...
        <div class="flex h-16 justify-between items-center">
          <div class="flex">
            <div class="flex flex-shrink-0 items-center">
              <router-link to="/" class="text-[#f4c03e] font-bold text-xl"
                >STRINGS</router-link
              >
            </div>
      ...
      <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p class="text-[#d8d8d8]">
              Empowering musicians through excellence in education.
            </p>
            <div class="mt-4">
              <p class="text-[#d8d8d8] font-semibold">
                Near Samford Hospital, Kokar Chowk
              </p>
              <p class="text-[#d8d8d8]">Ranchi, Jharkhand 834001.</p>
            </div>
          </div>
          <div>
            ...
            <ul class="space-y-2">
              <li v-for="item in navigation" :key="item.name">
                <router-link
                  :to="item.path"
                  class="text-[#d8d8d8] hover:text-[#f4c03e]"
                >
                  {{ item.name }}
                </router-link>
              </li>
          ...
          <div>
            ...
            <a
              ...
              class="text-[#d8d8d8] hover:text-[#f4c03e] block"
              >📞 8340-610-596, 6299-860-436</a
            >
            <a
              href="mailto:stringsmusic2022@gmail"
              class="text-[#d8d8d8] hover:text-[#f4c03e] block"
              >✉️ stringsmusic2022@gmail</a
            >
            <p class="text-[#d8d8d8] mt-2">
              📍 Near Samford Hospital, Kokar Chowk
            </p>
          </div>
          <div>
            ...
            <p class="text-[#d8d8d8] mb-4">
              Limited time offer. Book your trial class today.
            </p>
            <button
              @click="router.push('/contact')"
