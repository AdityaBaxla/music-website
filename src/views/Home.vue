  ...
  <div>
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col items-center justify-center min-h-[80vh] relative">
        <div class="absolute top-4 right-4 bg-red-500 text-white px-4 py-2 rounded-full animate-pulse">
          Limited Seats Available!
        </div>
        
        <div :class="{'rotate-90': isVertical}" class="transition-transform duration-500">
          <img src="/guitar.svg" alt="Electric Guitar" class="w-full max-w-3xl" />
        </div>
      ...
      <section class="py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="p-6 bg-[#1a1a1a] rounded-lg transform hover:scale-105 transition-transform">
            <h3 class="text-xl font-semibold mb-4 text-[#f4c03e]">Expert Instructors</h3>
            <p class="text-[#d8d8d8]">Learn from professional musicians with years of teaching experience.</p>
          </div>
          <div class="p-6 bg-[#1a1a1a] rounded-lg transform hover:scale-105 transition-transform">
            <h3 class="text-xl font-semibold mb-4 text-[#f4c03e]">Personalized Learning</h3>
            <p class="text-[#d8d8d8]">Tailored lessons that match your skill level and musical interests.</p>
          </div>
          <div class="p-6 bg-[#1a1a1a] rounded-lg transform hover:scale-105 transition-transform">
            <h3 class="text-xl font-semibold mb-4 text-[#f4c03e]">Modern Facilities</h3>
            <p class="text-[#d8d8d8]">State-of-the-art equipment and comfortable learning environments.</p>
          </div>
        </div>
      </section>
      ...
      <section class="py-16 bg-[#1a1a1a] rounded-lg">
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div v-for="achievement in achievements" :key="achievement" class="p-4">
              <p class="text-[#f4c03e] text-lg font-bold mb-2">{{ achievement }}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="swiper-wrapper">
            <div v-for="testimonial in testimonials" :key="testimonial.name" class="swiper-slide">
              <div class="bg-[#1a1a1a] p-6 rounded-lg h-full">
                ...
                <p class="text-[#f4c03e] font-semibold">- {{ testimonial.name }}</p>
              </div>
            </div>
          </div>
        </div>
